    ...
    <header className="sticky top-0 z-20 border-b border-[var(--border)] bg-white/80 backdrop-blur-xl">
      <div className="flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="hidden h-11 w-11 items-center justify-center rounded-2xl border border-[var(--border)] bg-white text-[var(--muted-foreground)] shadow-[var(--shadow-xs)] transition hover:text-[var(--foreground)] lg:flex">
